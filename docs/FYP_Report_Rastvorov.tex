...
This is important evidence for the thesis because it shows that the project explicitly tests real browser behavior and long-running media paths, not only narrow unit-level logic. It also reinforces a major theme of the implementation phase: the final system must be assessed as a workflow, not only as a set of isolated NLP functions.
