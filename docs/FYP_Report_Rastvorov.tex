...
Recursive Linguistic Elements (RLE) form the central model of data representation in ELA and, in practice, serve as its main working contract. The purpose of RLE is to translate the results of automatic linguistic analysis and all subsequent stages of interpretation into a single structured form. This form must satisfy several requirements at once: it must be stable enough for storage and validation, expressive enough for machine processing, and at the same time clear enough to be used in user-facing visualization and pedagogical interpretation.
