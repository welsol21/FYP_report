...
Authentic materials are attractive because they preserve the lexical, syntactic, pragmatic, and stylistic richness of real communication. They expose the learner to naturally occurring tense shifts, ellipsis, collocation, discourse markers, and speaker intent in a way that sanitized textbook examples often do not. At the same time, the very properties that make authentic input valuable also make it cognitively demanding.
...
Whisper-based transcription and M2M100-based translation represent the local model path visible in the codebase and documentation, while additional providers remain optional or comparative extensions. This multimodal dimension makes ELA more ambitious than a text-only parser, but it also increases integration fragility because sentence boundaries, timestamps, and translated artifacts must remain synchronized across several layers.
