...
The present study supports the claim that the grammar of linguistic structure is learnable from abstract recursive representations. At the same time, it does not yet provide a final answer to the question of how such a model behaves under further scaling, because the note inventory available within this study remains well below the size that would be required for a genuinely large and decisive experiment. The observed results and dynamics should therefore be treated as promising, but not yet final.
